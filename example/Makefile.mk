...
android_android_proto_compile_example:
	...
	bazel --batch build --cxxopt=-std=c++17 ${BAZEL_EXTRA_FLAGS} --verbose_failures --disk_cache=../../bazel-disk-cache //...
...
buf_buf_proto_breaking_test_example:
	...
	bazel --batch test --cxxopt=-std=c++17 ${BAZEL_EXTRA_FLAGS} --verbose_failures --test_output=errors --disk_cache=../../bazel-disk-cache //...

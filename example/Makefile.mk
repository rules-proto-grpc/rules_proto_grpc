android_android_proto_compile_example:
	...
	bazel --batch build --disk_cache=../../bazel-disk-cache //...
...
nodejs_examples: nodejs_nodejs_proto_compile_example nodejs_nodejs_grpc_compile_example
...
grpc.js_grpcjs_grpc_compile_example:
	cd example/github.com/stackb/grpc.js/grpcjs_grpc_compile; \
	bazel --batch build --disk_cache=../../../../bazel-disk-cache //...

grpc.js_grpcjs_grpc_library_example:
	cd example/github.com/stackb/grpc.js/grpcjs_grpc_library; \
	bazel --batch build --disk_cache=../../../../bazel-disk-cache //...

grpc.js_examples: grpc.js_grpcjs_grpc_compile_example grpc.js_grpcjs_grpc_library_example

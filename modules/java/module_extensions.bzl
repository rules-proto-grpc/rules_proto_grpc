...
def _download_plugins(module_ctx):
    ...
    for version, platform, hash in [
        ...
        ("1.77.0", "darwin-arm64", "<insert new hash here>"),
        ("1.77.0", "darwin-x86_64", "<insert new hash here>"),
        ("1.77.0", "linux-arm64", "<insert new hash here>"),
        ("1.77.0", "linux-x86_64", "<insert new hash here>"),
        ("1.77.0", "windows-x86_64", "<insert new hash here>"),
    ]:
        http_file(

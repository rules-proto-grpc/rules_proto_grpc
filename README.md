...
- **2020/10/xx**: [Version 2.0.0 has been released](https://github.com/rules-proto-grpc/rules_proto_grpc/releases/tag/2.0.0)
  with updated Protobuf and gRPC versions. For some languages it may be necessary to update your
  WORKSPACE file; please see the above release notes for details. If you discover any problems with
  the new release, please

...
GRPC_VERSION = "1.45.2"  # When updating, also update grpc hash, grpc-java hash, Go repositories.bzl, Ruby requirements and C#/F# requirements
BUF_VERSION = "v1.3.1"
VERSIONS = {
    # Core
    "rules_proto": {
    ...
    "io_grpc_grpc_java": {
        ...
        "org": "grpc",
        "repo": "grpc-java",
        # "ref": "v{}".format(GRPC_VERSION),  # TODO: switch back to this
        "ref": "v1.45.1",

...
var ciPlatforms = []string{"ubuntu2110", "windows", "macos"}
var ciPlatformsMap = map[string][]string{
	"linux":   []string{"ubuntu2110"},
...
var dotnetPlatformFlags = map[string][]string{
	"ubuntu2110": []string{"--host_platform=@io_bazel_rules_dotnet//dotnet/toolchain:linux_amd64_5.0.201", "--platforms=@io_bazel_rules_dotnet//dotnet/toolchain:linux_amd64_5.0.201"},
